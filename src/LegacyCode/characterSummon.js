// useEffect(()=>{
     ...
     //             SSR: [
     //                  {id: '', name: 'Maeda Atsuko', rarity: 'SSR', specialty: 'Aitakatta', hp: 2500, def: 1200, atk: 1200, leaderSkill: {skill1:{type: 'def', value: 2}}, leaderSkillText: "All 'Aitakatta' members gain double defense"},
     //                  {id: '', name: 'Oshima Mai', rarity: 'SSR', specialty: 'Aitakatta', hp: 2200, def: 1200, atk: 1300, leaderSkill: {skill1:{type: 'atk', value: 1.5}}, leaderSkillText: "All 'Aitakatta' members gain 50% more attack"},
     //                  {id: '', name: 'Takahashi Minami', rarity: 'SSR', specialty: 'Aitakatta', hp: 2700, def: 1350, atk: 1000, leaderSkill: {skill1:{type: 'hp', value: 3}}, leaderSkillText: "All 'Aitakatta' members gain 300% hp"},
     //                  {id: '', name: 'Shinoda Mariko', rarity: 'SSR', specialty: 'Aitakatta', hp: 2500, def: 1000, atk: 1500, leaderSkill: {skill1:{type: 'hp', value: 1.5}}, leaderSkillText: "All 'Aitakatta' members gain 50% more hp"},
     //                  {id: '', name: 'Minegishi Minami', rarity: 'SSR', specialty: 'Aitakatta', hp: 2000, def: 1100, atk: 1800, leaderSkill: {skill1:{type: 'atk', value: 3}}, leaderSkillText: "All 'Aitakatta members gain 300% more attack"},
     //            ],
     //              SR: [
     //                  {id: '', name: 'Kojima Haruna', rarity: 'SR', specialty: 'Aitakatta', hp: 2300, def: 1400, atk: 1200, leaderSkill: {skill1: {type: 'hp', value: 1.25}}, leaderSkillText: "All 'Aitakatta' members gain 25% more defense"},
     //                  {id: '', name: 'Itano Tomomi', rarity: 'SR', specialty: 'Aitakatta', hp: 1900, def: 1300, atk: 1400, leaderSkill: {skill1: {type: 'atk', value: 1.25}}, leaderSkillText: "All 'Aitakatta' members gain 25% more attack"},
     //                  {id: '', name: 'Kashiwagi Yuki', rarity: 'SR', specialty: 'Aitakatta', hp: 1800, def: 1300, atk: 1200, leaderSkill: {skill1: {type: 'def', value: 1.25}}, leaderSkillText: "All 'Aitakatta' members gain 25% hp"},
     //                  {id: '', name: 'Watanabe Mayu', rarity: 'SR', specialty: 'Aitakatta', hp: 2050, def: 1500, atk: 1500, leaderSkill: {skill1: {type: 'atk', value: 1.75}}, leaderSkillText: "All 'Aitakatta' members gain 75% more attack"},
     //                  {id: '', name: 'Akimoto Sayaka', rarity: 'SR', specialty: 'Aitakatta', hp: 2000, def: 1200, atk: 1550, leaderSkill: {skill1: {type: 'atk', value: 1.25}, skill2: {type: 'def', value: 1.25}}, leaderSkillText: "All 'Aitakatta' members gain 25% more attack and defense"},
     //            ],
     //              R: [
