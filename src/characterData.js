...
export const gameBanners = [
    ...
    },
    {
        ...
        bannerType: 'gear', 
        SSR: [
                {gearID: uuid(), name: 'Idols TOKYO headband',      type: 'hat',        rarity: 'SSR',  gearEffect: { effects: [{ type: 'def', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Normal Attire',       type: 'top',        rarity: 'SSR',  gearEffect: { effects: [{ type: 'atk', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Skirt',               type: 'bottom',     rarity: 'SSR',  gearEffect: { effects: [{ type: 'hp',  value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols High Heels',          type: 'shoes',      rarity: 'SSR',  gearEffect: { effects: [{ type: 'def', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Boquet',              type: 'accessory',  rarity: 'SSR',  gearEffect: { effects: [{ type: 'atk', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },

        ],
        SR: [
                {gearID: uuid(), name: 'Idols Training Headband',   type: 'hat',        rarity: 'SR',  gearEffect: { effects: [{ type: 'def', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Training Shirt',      type: 'top',        rarity: 'SR',  gearEffect: { effects: [{ type: 'atk', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Training Pants',      type: 'bottom',     rarity: 'SR',  gearEffect: { effects: [{ type: 'hp',  value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Training Shoes',      type: 'shoes',      rarity: 'SR',  gearEffect: { effects: [{ type: 'def', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Training Sweatbands', type: 'accessory',  rarity: 'SR',  gearEffect: { effects: [{ type: 'atk', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
        ],
        R: [
                {gearID: uuid(), name: 'Idols Sleeping Headband',   type: 'hat',        rarity: 'R',  gearEffect: { effects: [{ type: 'def', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Sleeping Shirt',      type: 'top',        rarity: 'R',  gearEffect: { effects: [{ type: 'atk', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Sleeping Pants',      type: 'bottom',     rarity: 'R',  gearEffect: { effects: [{ type: 'hp',  value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Sleeping Shoes',      type: 'shoes',      rarity: 'R',  gearEffect: { effects: [{ type: 'def', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Sleeping Sweatbands', type: 'accessory',  rarity: 'R',  gearEffect: { effects: [{ type: 'atk', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
        ],
        C: [
                {gearID: uuid(), name: 'Idols Lazy Headband',       type: 'hat',        rarity: 'C',  gearEffect: { effects: [{ type: 'def', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Lazy Shirt',          type: 'top',        rarity: 'C',  gearEffect: { effects: [{ type: 'atk', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Lazy Pants',          type: 'bottom',     rarity: 'C',  gearEffect: { effects: [{ type: 'hp',  value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Lazy Shoes',          type: 'shoes',      rarity: 'C',  gearEffect: { effects: [{ type: 'def', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
                {gearID: uuid(), name: 'Idols Lazy Sweatbands',     type: 'accessory',  rarity: 'C',  gearEffect: { effects: [{ type: 'atk', value: 1.2 }] }, numberMerges: 0, maxMerges: 5, saved: false },
        ]
    }
];