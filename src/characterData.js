...
export const gameBanners = [
    {
        ...
        SR: [
                ...
                {characterID: uuid(), name: 'Kashiwagi Yuki',   rarity: 'SR',   specialty: ['Flying Get'],   hp: 1800, def: 1300, atk: 1200, adjustedStats: { adjHP: 0, adjDef:0, adjAtk: 0 },   leaderSkill: {skills: [{type: 'def', value: 1.25}] }, leaderSkillText: "All 'Flying Get' idols gain 25% hp",                                                  leaderSkillSpecialitySpecific: true, appliesTo: ['Flying Get'], numberMerges: 0, maxMerges: 5, saved: false, hat: null, top: null, bottom: null, shoes: null, accessory: null },
    ...
    },
    {
        ...
        SR: [
                ...
                {characterID: uuid(), name: 'Takahashi Minami', rarity: 'SR',   specialty: ['Koi Suru Fortune Cookie'],   hp: 1800, def: 1300, atk: 1200, adjustedStats: { adjHP: 0, adjDef:0, adjAtk: 0 },   leaderSkill: {skills: [{type: 'def', value: 1.25}] },                             leaderSkillText: "All 'Koi Suru Fortune Cookie' idols gain 25% hp",                      leaderSkillSpecialitySpecific: true, appliesTo: ['Koi Suru Fortune Cookie'], numberMerges: 0, maxMerges: 5, saved: false, hat: null, top: null, bottom: null, shoes: null, accessory: null },
